                                ...
                                <div class="art-post-body">
									  ...
									  <div class="login_main_mid">
									    ...
									    <dl class="login_content">
									       <dt>email：</dt>
									       <dd><input id="email" name="email" value="${user.email }" type="text" class="login_content_input" /></dd>
									    </dl>
									     <dl class="login_content">
									       <dt>密码：</dt>
									       <dd>
									         <input id="password" name="password" value="${user.password }" type="password" class="login_content_input" />
									       </dd>
									     </dl>
									     <dl class="login_content">
									     	<dt></dt>
									     ...
									     <dl class="login_content">
									       <dt></dt>
									       <dd><div style="color:red;">${error_msg }</div><input id="btn" value=" " type="submit" class="login_btn_out" /></dd>
									    </dl>
									    </form>
